...
export const MockDashboard: React.FC = () => {
  return (
    <div className="mock-dashboard w-full max-w-[620px] mx-auto select-none overflow-hidden">
      {/* Header bar of Dashboard */}
      <div className="dashboard-header flex items-center justify-between px-4 py-3 text-slate-300">
        <div className="flex items-center gap-2">
          <svg className="w-[15px] h-[15px] fill-current text-slate-400" viewBox="0 0 24 24">
      ...
      <div className="grid grid-cols-12 min-h-[295px]">
        {/* Sidebar Nav */}
        ...
        <div className="col-span-9 p-3 flex flex-col gap-3 text-left">
          ...
          <div className="grid grid-cols-2 gap-2.5">
            ...
            <div className="metric-card">
              ...
              {/* Chart Plot Area */}
              <div className="relative h-[65px] w-full flex items-end">
                {/* Y-Axis scale labels */}
