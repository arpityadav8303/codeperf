      ...
      <div className="signup-form-panel">
        <div className="top-nav-utility">
          ...
          <div className="text-sm font-medium text-[#A6A6A6]">
            Already registered?{' '}
            <Link to="/login" className="font-semibold text-[#A6A6A6] hover:text-[#FF6C37] transition-colors">
              Sign in
            </Link>
          </div>
        </div>
        ...
        <div className="auth-panel-card flex flex-col gap-6">
          <div className="flex flex-col gap-2 text-center">
            ...
            <p className="text-xs text-[#A6A6A6]">Start optimizing your distributed systems codebase complexity today.</p>
          </div>
          ...
          <div className="w-full flex flex-col gap-4">
            <div className="relative flex items-center">
              <div className="grow border-t border-[#3A3A3A]" />
              <span className="shrink mx-4 text-[10px] uppercase tracking-wider font-semibold text-[#8F8F8F]">Or continue with</span>
              <div className="grow border-t border-[#3A3A3A]" />
            </div>
